...
public class QueryDslIT extends AbstractHibernateTest {
    ...
    @Test
    public void filterPayments(Session session) {
        // Given
        ...
        List<Payment> payments = queryFactory.selectFrom(qPayment)
    ...
    @Test
    void filterRides(Session session) {
        // Given
        User driver = session.createQuery("from User where email = 'toms@gmail.com'", User.class).uniqueResult();
        ...
        List<Ride> rides = queryFactory.selectFrom(qRide)
    ...
    @Test
    public void filterByOrder(Session session) {
        // Given
    ...
    @Test
    public void filterDailyOrders(Session session) {
        // Given
        User driver = session.createQuery("from User where email = 'toms@gmail.com'", User.class).uniqueResult();
